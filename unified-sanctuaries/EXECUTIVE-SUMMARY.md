...
flowchart TD
    ...
    US --> FARM["Permaculture Farm &<br/>Education Center<br/>$315K -- $1M+<br/>(Year 1-3)"]
    US --> RETREAT["Retreat & Healing Arts<br/>Center + Bathhouse<br/>$570K -- $1.75M<br/>(Year 1-3)"]
    US --> EVENT["Event Venue +<br/>Innovation Hall<br/>$310K -- $1.16M<br/>(Year 1-3)"]
    US --> LIVING["Community Living /<br/>Regen Neighborhood<br/>$195K -- $580K<br/>(Year 1-3)"]

    FARM --> TOTAL["COMBINED ANNUAL<br/>REVENUE POTENTIAL<br/>$1.4M -- $4.5M+<br/>(Year 1-3)"]
    RETREAT --> TOTAL
    EVENT --> TOTAL
    LIVING --> TOTAL
...
flowchart LR
    subgraph SOURCES["Capital Sources"]
        ...
        EARN["Other Sources<br/>of Revenue"]
    end

    DON --> US["UNIFIED<br/>SANCTUARIES<br/>$1M by 2026<br/>$10M by 2027<br/>$100M by 2029"]
    INV --> US
    MEM --> US
    EARN --> US
...
```mermaid
flowchart TD
    CLT["UNIFIED SANCTUARIES COMMUNITY LAND PROJECT<br/>Community Land Trust<br/>Non-Speculative Stewardship"]

    CLT --> SOL["UNIFIED SANCTUARIES TOKEN<br/>Utility Currency<br/>Goods & Services Exchange"]
    CLT --> VOICE["VOICE TOKEN<br/>Governance Token<br/>Decision-Making Weight"]
    CLT --> TRUST["TRUST UNITS<br/>Units Represent Contribution;<br/>Liquidatable on Exit"]
...
flowchart TD
    ...
    AC --> RETREAT_N["Retreat & Healing Arts Center<br/>Autonomous Node"]
...
```mermaid
flowchart LR
    P1["PHASE 1<br/>(Present - Q4 2026)<br/>Land & Foundation<br/>---<br/>Secure property<br/>Establish legal structures<br/>Invite early members<br/>$1M raise"]

    P2["PHASE 2<br/>(Q1 2027 - Q4 2028)<br/>Build & Activate<br/>---<br/>10+ total eco-homes built<br/>Farm & retreat facilities<br/>Launch circular economy<br/>Scale revenue<br/>$10M raise"]

    P3["PHASE 3<br/>(Q1 2029 onward)<br/>Blueprint & Network<br/>---<br/>20+ total eco-homes built<br/>Document learnings<br/>Publish open-source blueprint<br/>Support new sanctuaries<br/>Global hub<br/>$100M raise"]
...
flowchart TD
    ...
    PT["PERMATOURS<br/>NE Permaculture Action<br/>& Education Network"] -.-|"Trainings &<br/>workshops"| US
    DG["DIGGERS COOPERATIVE<br/>Compost Co-op"] -.-|"Soil &<br/>compost"| US
    BN["BIRDS NEST BUILDERS<br/>Natural Builder Co-op"] -.-|"Natural<br/>building"| US
    MM["MICELIO MEDIA<br/>Film & Documentary"] -.-|"Film &<br/>media"| US
    ML["MYCELIAL LAW<br/>Earth Law Firm"] -.-|"Legal<br/>services"| US
    ...
    US -.-|"Open-source<br/>blueprint"| WIDER["WIDER ECOVILLAGE /<br/>REGENERATIVE LIVING /<br/>BIOREGIONAL MOVEMENT<br/>Other land-based communities<br/>learn and adapt the model<br/>per their unique use case"]

    style US fill:#8D6E63,stroke:#5D4037,color:#fff
    style PT fill:#4CAF50,stroke:#2E7D32,color:#fff
    style DG fill:#8BC34A,stroke:#689F38,color:#000
    style BN fill:#A1887F,stroke:#795548,color:#fff
    style MM fill:#42A5F5,stroke:#1565C0,color:#fff
    style ML fill:#7E57C2,stroke:#512DA8,color:#fff
    style EP fill:#26A69A,stroke:#00897B,color:#fff
    style LB fill:#F9A825,stroke:#F57F17,color:#000
    style HB fill:#CE93D8,stroke:#AB47BC,color:#000
    style PT2 fill:#FFB74D,stroke:#FF9800,color:#000
    style RC fill:#66BB6A,stroke:#43A047,color:#000
    style SD fill:#29B6F6,stroke:#0288D1,color:#fff

# Kinship Earth Community Call - Meeting Outline
**Thursday, March 5, 2026 | 5 PM EST / 2 PM PST | 90 Minutes**

*Personal facilitator guide for Sydney*

---

## Pre-Meeting Prep

**Docs to share in advance or during the call (via chat/email):**
- Kinship Earth Executive Summary (PDF)
- Flow Funder Stories of Impact (PDF or link to homepage stories)
...
**Tech setup:**
- Screen share ready with key slides/docs
- Chat open for links and questions
- Recording (ask permission at the top)

---

## Meeting Flow

### 1. Welcome & Opening (5 min) | 5:00 - 5:05 PM

- Welcome everyone, express gratitude for their presence and ongoing support
- Acknowledge the range of roles on the call: Board Members, Board of Advisors, Team Members, Flow Fund Advisors
- Brief note on format: "This is a conversation, not a presentation - I'll share updates, but most importantly I want to hear from you"
- Ask permission to record (if applicable)

---

### 2. Check-In Round (15 min) | 5:05 - 5:20 PM

- Prompt: *"In a minute or two, share what's alive for you right now - personally, in your work, or in relation to Kinship Earth."*
- ~1-2 min per person (depending on group size - adjust if more than 10 people show up; if 15+, do a quick one-sentence round instead)
- You go last or first to model brevity

---

### 3. Where We Are Now - State of Kinship Earth (15 min) | 5:20 - 5:35 PM

**Key data points to share:**
- $800K+ raised since 2024
- $360K+ deployed in flow funding grants
...
**Cohort highlights:**
- **Cohort 1** (Oct 2024): 17 recipients - 9 changemakers + 8 orgs. Inaugurated the Community of Practice. Broad thematic range: food sovereignty, environmental defense, Indigenous sovereignty, ecosystem restoration
...
### 4. How the Work Is Evolving (10 min) | 5:35 - 5:45 PM

**Kinship Earth's dual role:**
1. Flow Funding practitioner (deploying capital)
...
- 5-year: $10M+ deployed, 100+ grants, 20+ bioregional Flow Funds seeded
- 10-year: $200M raised and deployed

**Immediate needs:**
- Fundraising: all flow funding capital deployed/committed - need to raise more to renew Cohort 1 & 2 grants and expand
...
### 6. Open Discussion - Questions, Feedback & Ideas (30 min) | 5:55 - 6:25 PM

**This is the heart of the call - protect this time.**

**Framing prompt:** *"I'd love to open it up now. What questions do you have? What feedback, ideas, or connections come to mind as you hear about where we are and where we're heading? What do you think we should be paying attention to?"*

**If conversation needs seeding, use these prompts:**
- "How can we increase our impact given where we are?"
- "What opportunities do you see for strategic partnerships or joint fundraising?"
- "What feedback do you have on the Playbook concept or the NE Activation Series?"
- "Are there funders or networks we should be connecting with?"
- "How would you like to be more involved?"
- "What risks or blind spots should we be thinking about?"

**Take notes on:**
- Specific introductions or connections offered
- Ideas for fundraising or partnerships
- Feedback on strategy or programs
- Offers of deeper involvement
- Questions that need follow-up

---

### 7. Closing & Next Steps (5 min) | 6:25 - 6:30 PM

- Recap key takeaways and action items from the discussion
- Share how people can stay involved:
  - Make introductions to aligned funders
  - Contribute to the Playbook
  - Attend or support the NE Bioregional Activation Series
  - Join future Communities of Practice
  - Donate or direct DAF grants to Kinship Earth
- Mention you'll send a follow-up email with:
  - Key docs discussed (Executive Summary, Impact doc, Playbook overview, Stories of Impact)
  - Summary of the conversation and next steps
  - Any specific asks that came up
- Express deep gratitude: "Thank you for the care, trust, and guidance you've offered along the way. This work is only possible because of this community."
- Close with intention or a brief moment of appreciation
...
|---------|----------|------------|
| Welcome & Opening | 5 min | 5 min |
| Check-In Round | 15 min | 20 min |
| State of Kinship Earth | 15 min | 35 min |
| How the Work Is Evolving | 10 min | 45 min |
| Priorities & Needs | 10 min | 55 min |
| Open Discussion | 30 min | 85 min |
| Closing & Next Steps | 5 min | 90 min |

---

## Reminders for Yourself

- **Keep presentations concise** - you have 35 min total for sharing, save the rest for them
- **Don't rush the check-in** - it builds relational foundation for the whole call
- **Name the ask clearly** - don't be shy about what you need from them
- **Take notes or ask someone to take notes** during the open discussion
- **Watch the clock** at 5:55 PM - transition to open discussion no matter what
- **Follow up within 48 hours** with a summary email and shared docs
- **This group includes Marion Rockefeller Weber** - acknowledge the lineage and her pioneering role if she's on the call

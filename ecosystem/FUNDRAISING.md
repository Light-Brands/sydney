...
flowchart TD
    ...
    style BIOREGIONAL fill:#E8F5E9,stroke:#4CAF50,color:#000
    style LOCAL fill:#EFEBE9,stroke:#8D6E63,color:#000
    ...
    style NEED fill:#00796B,stroke:#004D40,color:#fff
```
...
```mermaid
flowchart LR
    DONORS["Donors &<br/>Foundations"] --> KE["KINSHIP EARTH<br/>Financial Infrastructure"]
    KE -->|"Flow Funds"| FF["Flow Funders<br/>18+ across 12+ bioregions"]
    KE -->|"Fiscal sponsorship<br/>& coordination"| PP["Planetary Party"]
    KE -->|"Outward capital<br/>to communities"| PT["Permatours"]
    KE -.-|"Case study;<br/>firewalled"| US["Unified Sanctuaries"]
    FF --> COMMUNITIES["Grassroots Communities<br/>Worldwide"]
    PT --> COMMUNITIES
    PP --> COMMUNITIES
    ...
    style PT fill:#4CAF50,stroke:#2E7D32,color:#fff
    style US fill:#8D6E63,stroke:#5D4037,color:#fff
    style COMMUNITIES fill:#E8F5E9,stroke:#81C784,color:#000
```
...
flowchart LR
    ...
    subgraph GROWTH["GROWTH STAGE"]
        T4["$100K<br/>Groundwork"]
        T5["$250K<br/>Canopy"]
        T6["$500K<br/>Grove"]
    end

    subgraph SCALE["SCALE STAGE"]
        T7["$1M<br/>Watershed"]
        T8["$5M<br/>Forest"]
        T9["$10M<br/>Mountain Range"]
    end

    subgraph PLANETARY_STAGE["PLANETARY STAGE"]
        T10["$25M<br/>Continental Shelf"]
        T11["$50M<br/>Ocean Current"]
        T12["$100M<br/>Planetary"]
    end

    T1 --> T2 --> T3 --> T4 --> T5 --> T6 --> T7 --> T8 --> T9 --> T10 --> T11 --> T12

    style EARLY fill:#E8F5E9,stroke:#81C784,color:#000
    style GROWTH fill:#C8E6C9,stroke:#66BB6A,color:#000
    style SCALE fill:#A5D6A7,stroke:#4CAF50,color:#000
    style PLANETARY_STAGE fill:#66BB6A,stroke:#2E7D32,color:#000
    style T1 fill:#E8F5E9,stroke:#81C784,color:#000
    style T2 fill:#E8F5E9,stroke:#81C784,color:#000
    style T3 fill:#E8F5E9,stroke:#81C784,color:#000
    style T4 fill:#C8E6C9,stroke:#66BB6A,color:#000
    style T5 fill:#C8E6C9,stroke:#66BB6A,color:#000
    style T6 fill:#C8E6C9,stroke:#66BB6A,color:#000
    style T7 fill:#A5D6A7,stroke:#4CAF50,color:#000
    style T8 fill:#A5D6A7,stroke:#4CAF50,color:#000
    style T9 fill:#A5D6A7,stroke:#4CAF50,color:#000
    style T10 fill:#66BB6A,stroke:#2E7D32,color:#fff
    style T11 fill:#66BB6A,stroke:#2E7D32,color:#fff
...
```mermaid
flowchart TD
    IMPACT["IMPACT<br/>TRACKING<br/>FRAMEWORK"]

    IMPACT --> PC["People &<br/>Communities<br/>---<br/>Direct participants<br/>Indirect beneficiaries"]
    IMPACT --> BA["Bioregions<br/>Activated<br/>---<br/>Geographic spread<br/>of funding & presence"]
    IMPACT --> LE["Land &<br/>Ecosystems<br/>---<br/>Acres in trust<br/>Restoration projects"]
    IMPACT --> CD["Capital<br/>Deployed<br/>---<br/>Flow Funds to<br/>grassroots leaders"]
    IMPACT --> DI["Digital<br/>Infrastructure<br/>---<br/>Platform features<br/>Community tools"]
    IMPACT --> CR["Cultural<br/>Reach<br/>---<br/>Events, media<br/>Education"]
    IMPACT --> RE["Replication<br/>---<br/>Blueprints shared<br/>Chapters launched"]

    style IMPACT fill:#00796B,stroke:#004D40,color:#fff
    style PC fill:#E3F2FD,stroke:#42A5F5,color:#000
    style BA fill:#E8F5E9,stroke:#4CAF50,color:#000
    style LE fill:#C8E6C9,stroke:#66BB6A,color:#000
    style CD fill:#FFF9C4,stroke:#F9A825,color:#000
    style DI fill:#E1BEE7,stroke:#AB47BC,color:#000
    style CR fill:#FFCCBC,stroke:#FF7043,color:#000
    style RE fill:#B2DFDB,stroke:#26A69A,color:#000
```
...
flowchart TD
    ...
    SEED --> KE["Kinship Earth<br/>---<br/>Legal fees, compliance<br/>Accounting, fundraising tools"]
    SEED --> PP["Planetary Party<br/>---<br/>Outreach materials<br/>Community agreements"]
    SEED --> PT["Permatours<br/>---<br/>Documentation equipment<br/>Volunteer tools"]
    SEED --> US["Unified Sanctuaries<br/>---<br/>Engagement materials<br/>Planning documents"]
    SEED --> APP["App & Digital<br/>---<br/>Domain, landing page<br/>Hosting setup"]

    style SEED fill:#E8F5E9,stroke:#81C784,color:#000
    style KE fill:#42A5F5,stroke:#1565C0,color:#fff
    style PP fill:#F9A825,stroke:#F57F17,color:#000
    style PT fill:#4CAF50,stroke:#2E7D32,color:#fff
    style US fill:#8D6E63,stroke:#5D4037,color:#fff
    style APP fill:#AB47BC,stroke:#7B1FA2,color:#fff
```
...
```mermaid
flowchart TD
    CANOPY["$250K -- CANOPY<br/>Full-Time Core Team"]

    CANOPY --> TEAM["Dedicated Professionals<br/>Across All Entities"]

    TEAM --> KE_T["KE: Flow Fund<br/>Deployment Cycle<br/>$75-100K deployed"]
    TEAM --> PP_T["PP: Professional<br/>Storytelling &<br/>Media Production"]
    TEAM --> PT_T["PT: Chapters Model<br/>Design & Community<br/>Marketplace Pilot"]
    TEAM --> US_T["US: Site Search<br/>Committee &<br/>Feasibility Studies"]
    TEAM --> APP_T["APP: Dual-Token<br/>Beta & Community<br/>Marketplace Live"]

    style CANOPY fill:#C8E6C9,stroke:#66BB6A,color:#000
    style TEAM fill:#00796B,stroke:#004D40,color:#fff
    style KE_T fill:#42A5F5,stroke:#1565C0,color:#fff
    style PP_T fill:#F9A825,stroke:#F57F17,color:#000
    style PT_T fill:#4CAF50,stroke:#2E7D32,color:#fff
    style US_T fill:#8D6E63,stroke:#5D4037,color:#fff
    style APP_T fill:#AB47BC,stroke:#7B1FA2,color:#fff
```
...
```mermaid
flowchart LR
    subgraph PP_DEPLOY["Planetary Party Protocol<br/>Multi-Bioregion Deployments"]
        COL["Colombia<br/>Forest & watershed<br/>restoration"]
        JAM["Jamaica<br/>Indigenous-led<br/>stewardship"]
        MEX["Mexico<br/>Cloud Forest<br/>bioregion"]
        NE["NE Turtle Island<br/>Bioregional<br/>activation series"]
    end

    PP_DEPLOY --> POS["Positive-Trace Infrastructure<br/>Gardens, governance models<br/>Water systems, relationships"]

    style PP_DEPLOY fill:#FFF8E1,stroke:#F9A825,color:#000
    style COL fill:#FFE082,stroke:#FFD54F,color:#000
    style JAM fill:#FFE082,stroke:#FFD54F,color:#000
    style MEX fill:#FFE082,stroke:#FFD54F,color:#000
    style NE fill:#FFE082,stroke:#FFD54F,color:#000
    style POS fill:#00796B,stroke:#004D40,color:#fff
```
...
```mermaid
flowchart TD
    subgraph TOKENOMICS["Tokenomics Journey: Design → Beta → Production"]
        SANDBOX["$100K: Design Sandbox<br/>Community co-creates rules<br/>Simulation & education"]
        BETA["$250K: Live Beta<br/>Real tokens, early adopters<br/>Marketplace pilot"]
        PROD["$500K: Production<br/>Full network circulation<br/>Governance decisions live"]
    end

    SANDBOX -->|"Rules validated"| BETA
    BETA -->|"Community tested"| PROD

    style TOKENOMICS fill:#FFF9C4,stroke:#FFF176,color:#000
    style SANDBOX fill:#BBDEFB,stroke:#90CAF9,color:#000
    style BETA fill:#90CAF9,stroke:#42A5F5,color:#000
...
```mermaid
flowchart TD
    WATERSHED["$1M -- WATERSHED<br/>Proof of Concept → Field Leader"]

    WATERSHED --> KE_W["Kinship Earth<br/>Approaching $2M target<br/>25+ Flow Funders<br/>Institutional partnerships"]
    WATERSHED --> PT_W["Permatours<br/>3-5 chapters live<br/>25+ hub partnerships<br/>Mutual aid operational"]
    WATERSHED --> PP_W["Planetary Party<br/>5+ bioregional deployments<br/>Guild ecosystem sustaining<br/>Earth Council activated"]
    WATERSHED --> US_W["Unified Sanctuaries<br/>Active land search<br/>Deposit on priority site<br/>Community forming"]
    WATERSHED --> APP_W["Digital Permaculture<br/>Platform v1<br/>Bioregional dashboard<br/>Capital flow tracking"]

    style WATERSHED fill:#A5D6A7,stroke:#4CAF50,color:#000
    style KE_W fill:#42A5F5,stroke:#1565C0,color:#fff
    style PT_W fill:#4CAF50,stroke:#2E7D32,color:#fff
    style PP_W fill:#F9A825,stroke:#F57F17,color:#000
    style US_W fill:#8D6E63,stroke:#5D4037,color:#fff
    style APP_W fill:#AB47BC,stroke:#7B1FA2,color:#fff
```
...
```mermaid
flowchart TD
    PLATFORM["DIGITAL PERMACULTURE<br/>PLATFORM v1"]

    PLATFORM --> BID["Bioregional Intelligence<br/>Dashboard<br/>---<br/>Real-time visualization<br/>of ecosystem activity"]
    PLATFORM --> TCF["Transparent Capital<br/>Flow Tracking<br/>---<br/>Every Flow Fund grant<br/>visible with consent"]
    PLATFORM --> CEM["Cross-Entity<br/>Membership<br/>---<br/>Single identity across<br/>all four entities"]
    PLATFORM --> ML["Media Library<br/>---<br/>Full content archive<br/>Search & licensing"]

    style PLATFORM fill:#AB47BC,stroke:#7B1FA2,color:#fff
    style BID fill:#B2EBF2,stroke:#26C6DA,color:#000
    style TCF fill:#FFF9C4,stroke:#F9A825,color:#000
    style CEM fill:#C8E6C9,stroke:#81C784,color:#000
    style ML fill:#FFCCBC,stroke:#FF7043,color:#000
```
...
```mermaid
flowchart TD
    FOREST["$5M -- FOREST<br/>Physical & Digital Converge"]

    FOREST --> US_F["Unified Sanctuaries<br/>LAND ACQUIRED<br/>Phase 1 Development"]

    US_F --> HOMES["5-8 Eco-Homes"]
    US_F --> FARM["Permaculture Farm<br/>Established"]
    US_F --> RETREAT["Retreat Center<br/>Groundwork"]

    FOREST --> KE_F["Kinship Earth<br/>Multi-Million $<br/>Flow Fund Cycles<br/>40+ Flow Funders"]
    FOREST --> PP_F["Planetary Party<br/>All 9 Guilds Active<br/>15+ Bioregional<br/>Deployments"]
    FOREST --> PT_F["Permatours<br/>8+ Active Chapters<br/>Token Economy<br/>Operational"]
    FOREST --> APP_F["App: Federated<br/>Architecture<br/>Self-Hosted Nodes<br/>Open-Source Tools"]

    style FOREST fill:#A5D6A7,stroke:#4CAF50,color:#000
    style US_F fill:#8D6E63,stroke:#5D4037,color:#fff
    style HOMES fill:#EFEBE9,stroke:#BCAAA4,color:#000
    style FARM fill:#C8E6C9,stroke:#81C784,color:#000
    style RETREAT fill:#E1BEE7,stroke:#CE93D8,color:#000
    style KE_F fill:#42A5F5,stroke:#1565C0,color:#fff
    style PP_F fill:#F9A825,stroke:#F57F17,color:#000
    style PT_F fill:#4CAF50,stroke:#2E7D32,color:#fff
    style APP_F fill:#AB47BC,stroke:#7B1FA2,color:#fff
```
...
flowchart TD
    ...
    FED --> CORE["Core Platform<br/>Shared protocols<br/>& identity"]

    CORE --> N1["Permatours<br/>Chapter Node<br/>(self-hosted)"]
    CORE --> N2["PP Bioregional<br/>Node<br/>(self-hosted)"]
    CORE --> N3["Sanctuary<br/>Node<br/>(self-hosted)"]
    CORE --> N4["Independent<br/>Community Node<br/>(self-hosted)"]

    N1 & N2 & N3 & N4 --> OS["Open-Source<br/>Blueprint Tools<br/>---<br/>Fork, adapt, own"]

    style FED fill:#AB47BC,stroke:#7B1FA2,color:#fff
    style CORE fill:#E1BEE7,stroke:#CE93D8,color:#000
    style N1 fill:#4CAF50,stroke:#2E7D32,color:#fff
    style N2 fill:#F9A825,stroke:#F57F17,color:#000
    style N3 fill:#8D6E63,stroke:#5D4037,color:#fff
    style N4 fill:#E0E0E0,stroke:#9E9E9E,color:#000
    style OS fill:#00796B,stroke:#004D40,color:#fff
```
...
```mermaid
flowchart TD
    US_FULL["UNIFIED SANCTUARIES<br/>Fully Operational"]

    US_FULL --> FARM_F["Permaculture Farm<br/>& Education Center<br/>$315K -- $1M+"]
    US_FULL --> RETREAT_F["Retreat & Healing Arts<br/>Center + Bathhouse<br/>$570K -- $1.75M"]
    US_FULL --> EVENT_F["Event Venue +<br/>Innovation Hall<br/>$310K -- $1.16M"]
    US_FULL --> LIVING_F["Community Living<br/>20+ Eco-Homes<br/>$195K -- $580K"]

    FARM_F --> REV["COMBINED ANNUAL<br/>REVENUE POTENTIAL<br/>$1.4M -- $4.5M+"]
    RETREAT_F --> REV
    EVENT_F --> REV
    LIVING_F --> REV

    style US_FULL fill:#8D6E63,stroke:#5D4037,color:#fff
    style FARM_F fill:#A5D6A7,stroke:#66BB6A,color:#000
    style RETREAT_F fill:#CE93D8,stroke:#AB47BC,color:#000
    style EVENT_F fill:#FFE082,stroke:#FFD54F,color:#000
    style LIVING_F fill:#90CAF9,stroke:#64B5F6,color:#000
    style REV fill:#EF5350,stroke:#C62828,color:#fff
```
...
```mermaid
flowchart TD
    OCEAN["$50M -- OCEAN CURRENT<br/>Global Network Operational"]

    OCEAN --> SANCTUARIES["5-10 Sanctuary Sites<br/>Worldwide<br/>Each self-sustaining<br/>$5M+ combined revenue"]
    OCEAN --> FLOW["$15M+ Annual<br/>Flow Fund Deployment<br/>100+ Flow Funders<br/>50+ Independent Funds"]
    OCEAN --> CHAPTERS["Chapters on Every<br/>Inhabited Continent<br/>Token economies in<br/>multiple regions"]
    OCEAN --> PROTOCOL["Protocol Standard<br/>for Regenerative<br/>Movements Globally<br/>40+ deployments"]
    OCEAN --> DIGITAL["Full Digital Permaculture<br/>Ecosystem Operational<br/>50,000+ members<br/>6 continents"]

    style OCEAN fill:#66BB6A,stroke:#2E7D32,color:#fff
    style SANCTUARIES fill:#8D6E63,stroke:#5D4037,color:#fff
    style FLOW fill:#42A5F5,stroke:#1565C0,color:#fff
    style CHAPTERS fill:#4CAF50,stroke:#2E7D32,color:#fff
    style PROTOCOL fill:#F9A825,stroke:#F57F17,color:#000
    style DIGITAL fill:#AB47BC,stroke:#7B1FA2,color:#fff
```
...
```mermaid
flowchart TD
    PLANETARY["$100M -- PLANETARY<br/>Permanent Regenerative Infrastructure"]

    PLANETARY --> KE_P["Kinship Earth<br/>$200M vision approached<br/>150+ Flow Funders<br/>100+ Independent Funds<br/>Reshaping philanthropy"]
    PLANETARY --> PP_P["Planetary Party<br/>Global coordination standard<br/>60+ bioregional deployments<br/>Thousands of communities"]
    PLANETARY --> PT_P["Permatours<br/>Every continent<br/>Mature token economies<br/>Model for post-extractive economics"]
    PLANETARY --> US_P["Unified Sanctuaries<br/>15-20+ sites worldwide<br/>$15M+ combined revenue<br/>10,000+ acres in trust"]
    PLANETARY --> APP_P["Regenerative Internet<br/>Federated digital sanctuaries<br/>Open-source commons<br/>100,000+ members"]

    KE_P & PP_P & PT_P & US_P & APP_P --> PERMANENT["PERMANENT<br/>REGENERATIVE<br/>INFRASTRUCTURE<br/>LAYER"]

    style PLANETARY fill:#4CAF50,stroke:#1B5E20,color:#fff
    style KE_P fill:#42A5F5,stroke:#1565C0,color:#fff
    style PP_P fill:#F9A825,stroke:#F57F17,color:#000
    style PT_P fill:#4CAF50,stroke:#2E7D32,color:#fff
    style US_P fill:#8D6E63,stroke:#5D4037,color:#fff
    style APP_P fill:#AB47BC,stroke:#7B1FA2,color:#fff
    style PERMANENT fill:#00796B,stroke:#004D40,color:#fff
```
...
```mermaid
flowchart TD
    FF["FLOW FUNDING<br/>Self-Perpetuating<br/>---<br/>Each Flow Funder<br/>recommends the next cohort"]
    BP["BLUEPRINTS<br/>Enable Replication<br/>---<br/>Open-source models<br/>adopted by strangers"]
    COM["COMMUNITIES<br/>Enable Communities<br/>---<br/>Chapters learn from chapters<br/>Sanctuaries adapt sanctuaries"]
    DIG["DIGITAL INFRASTRUCTURE<br/>Compounds Everything<br/>---<br/>Every feature built<br/>serves every community after"]

    FF --> COMPOUND["ECOLOGICAL<br/>COMPOUNDING<br/>---<br/>Each tier multiplies<br/>the impact of the next"]
    BP --> COMPOUND
    COM --> COMPOUND
    DIG --> COMPOUND

    style FF fill:#42A5F5,stroke:#1565C0,color:#fff
    style BP fill:#F9A825,stroke:#F57F17,color:#000
    style COM fill:#4CAF50,stroke:#2E7D32,color:#fff
    style DIG fill:#AB47BC,stroke:#7B1FA2,color:#fff
    style COMPOUND fill:#00796B,stroke:#004D40,color:#fff
```
